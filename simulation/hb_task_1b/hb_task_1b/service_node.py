...
class ServiceNode(Node):
    ...
    def __init__(self):
        ...
        self.service = self.create_service(NextGoal, 'next_goal', self.next_goal_callback)
...
def main(args=None):
    ...
    service_node.get_logger().info(f"Shape: {random_shape_function_name}")
    service_node.get_logger().info(f"Shape data: {shape_data}")
